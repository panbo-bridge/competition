...
josn_path = "../train_data/guangdong_Annotations/Annotations/anno_train.json"
image_path = "../train_data/guangdong_images/defect/"
...
with open(josn_path, encoding='utf-8') as f:
    ...
    for fold in [0]:
        ...
        for num, name in enumerate(name_list):
            ...
            with open('convertor/fold{}/labels/'.format(fold) + path2save + name.split('.')[0] + ".txt", 'a+',encoding='utf-8') as f:
                for data in row:
                    f.write('{} '.format(data))
                f.write('\n')
