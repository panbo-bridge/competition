...
class VQAModel(nn.Module):
    def __init__(self, num_answers, model = 'lxmert'):
        ...
        # VQA Answer heads
        if args.mode == "title" and args.model == "visualbert":
            self.branch1x1 = nn.Conv1d(1, 4, kernel_size=1)
        elif args.mode == "attr" and args.model == "visualbert":
            pass
        else:
            self.branch1x1 = nn.Conv1d(1,16,kernel_size=1)
